...
class layer_t {
    ...
    activation_function_t activation_func;

    public:

    layer_t(size_t _num_nodes_in, size_t _num_nodes_out, activation_function_t _activation_func = activation_function::linear) 
